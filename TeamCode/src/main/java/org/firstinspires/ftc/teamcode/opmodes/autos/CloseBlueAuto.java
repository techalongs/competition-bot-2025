...
public class CloseBlueAuto extends OpMode {
    ...
    private void buildPaths() {
        ...
        paths[3] = getPath(BluePosition.SHORT_COLLECT, BluePosition.DUMP_PREP); // Prep to dump
        paths[4] = getPath(BluePosition.DUMP_PREP, BluePosition.DUMP); // Dump
        paths[5] = getPath(BluePosition.DUMP, BluePosition.SHORT_SHOOT); // Score
        paths[6] = getPath(BluePosition.SHORT_SHOOT, BluePosition.MID_COLLECT_PREP); // Prep to collect
        paths[7] = getPath(BluePosition.MID_COLLECT_PREP, BluePosition.MID_COLLECT); // Collect
