...
@TeleOp(name = "Two Controllers • AutoAim", group = "Experimental")
public class TwoControllersAutoAim extends OpMode {
    ...
    public void init() {
        ...
        teamColor = (TeamColor) blackboard.get(TeamColor.class.getSimpleName());
    }
