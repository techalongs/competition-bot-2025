...
public class AnnaControls extends SubsystemBase {
    ...
    public AnnaControls(GamepadEx driver1, GamepadEx driver2, Robot robot, Robot robot1, CommandScheduler commandScheduler, REVColorSensor sensor1, REVColorSensor sensor2) {
        ...
        driver2.getTrigger(GamepadKeys.Trigger.RIGHT_TRIGGER).(new DeferredCommand(() -> robot.launchAll(launcherPower), null));
