...
public enum BluePosition {
    SHORT_START(new Pose(20, 123, Math.toRadians(140))),
    ...
    SHORT_COLLECT(new Pose(15, 84, Math.toRadians(180))),
    MID_COLLECT_PREP(new Pose(45, 60.5, Math.toRadians(180))),
    MID_COLLECT(new Pose(13, 60.5, Math.toRadians(180))),
    LONG_COLLECT_PREP(new Pose(49, 37, Math.toRadians(180))),
    LONG_COLLECT(new Pose(20, 37, Math.toRadians(180))),
