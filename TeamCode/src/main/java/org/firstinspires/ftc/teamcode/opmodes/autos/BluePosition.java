...
public enum BluePosition {
    SHORT_START(new Pose(18, 120, Math.toRadians(135))),
    LONG_START(new Pose(56, 8, Math.toRadians(90))),
    SHORT_SHOOT(new Pose(25, 100, Math.toRadians(135))),
    ...
    MID_COLLECT_PREP(new Pose(44, 67, Math.toRadians(180))),
    MID_COLLECT(new Pose(17, 67, Math.toRadians(180))),
    LONG_COLLECT_PREP(new Pose(44, 35, Math.toRadians(180))),
    LONG_COLLECT(new Pose(17, 35, Math.toRadians(180))),
