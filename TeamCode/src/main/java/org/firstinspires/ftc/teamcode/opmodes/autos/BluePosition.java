...
public enum BluePosition {
    ...
    SHORT_COLLECT_PREP(new Pose(44, 84.5, Math.toRadians(180))),
    SHORT_COLLECT(new Pose(13, 84.5, Math.toRadians(180))),
    ...
    DUMP_PREP(new Pose(21, 80, Math.toRadians(90))),
    DUMP(new Pose(16, 80, Math.toRadians(90))),
