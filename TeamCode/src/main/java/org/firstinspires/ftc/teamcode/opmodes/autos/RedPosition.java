...
public enum RedPosition {
    ...
    SHORT_SHOOT(new Pose(110, 110, Math.toRadians(45))),
    LONG_SHOOT(new Pose(56, 36, Math.toRadians(67))),
    SHORT_COLLECT_PREP(new Pose(95, 83.5, Math.toRadians(0))),
    SHORT_COLLECT(new Pose(120, 83.5, Math.toRadians(0))),
    MID_COLLECT_PREP(new Pose(95, 59.5, Math.toRadians(0))),
    MID_COLLECT(new Pose(120, 59.5, Math.toRadians(0))),
