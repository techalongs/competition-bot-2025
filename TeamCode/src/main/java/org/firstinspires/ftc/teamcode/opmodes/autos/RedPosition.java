...
public enum RedPosition {
    SHORT_START(new Pose(128, 123, Math.toRadians(40))),
    ...
    SHORT_COLLECT_PREP(new Pose(95, 84, Math.toRadians(0))),
    SHORT_COLLECT(new Pose(122, 84, Math.toRadians(0))),
    MID_COLLECT_PREP(new Pose(95, 60, Math.toRadians(0))),
    MID_COLLECT(new Pose(122, 60, Math.toRadians(0))),
    LONG_COLLECT_PREP(new Pose(95, 37, Math.toRadians(0))),
    LONG_COLLECT(new Pose(124, 37, Math.toRadians(0))),
