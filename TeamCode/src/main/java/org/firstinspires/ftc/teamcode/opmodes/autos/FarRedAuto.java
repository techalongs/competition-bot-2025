...
//        paths[7] = getPath(RedPosition.DUMP_PREP, RedPosition.DUMP); // Dump
        paths[8] = getPath(RedPosition.MID_COLLECT, RedPosition.MID_COLLECT_PREP); // Back up
        paths[9] = getPath(RedPosition.MID_COLLECT_PREP, RedPosition.SHORT_SHOOT); // Score
        paths[10] = getPath(RedPosition.SHORT_SHOOT, RedPosition.LONG_COLLECT_PREP); // Prep to collect
        paths[11] = getPath(RedPosition.LONG_COLLECT_PREP, RedPosition.LONG_COLLECT); // Collect
        paths[12] = getPath(RedPosition.LONG_COLLECT, RedPosition.SHORT_SHOOT); // Score
        paths[13] = getPath(RedPosition.SHORT_SHOOT, RedPosition.SHORT_END); // Park
    }
